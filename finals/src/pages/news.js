                ...
                <div className="col-news">
                    <div className="news-card card h-100">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://news.un.org/en/story/2023/06/1138057" className="btn btn-secondary" target="_blank">Continue Reading</a>
                        </div>
                    </div>
                </div>
                <div className="col-news">
                    <div className="news-card card h-100">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://news.un.org/en/story/2023/06/1137687" className="btn btn-secondary" target="_blank" >Continue Reading</a>
                        </div>
                    </div>
                </div>
                <div className="col-news">
