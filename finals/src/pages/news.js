                ...
                <div className="col">
                    <div className="news-card card h-100">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://news.un.org/en/story/2023/06/1138057" className="btn btn-primary" target="_blank">Continue Reading</a>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="news-card card h-100">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://news.un.org/en/story/2023/06/1137687" className="btn btn-primary" target="_blank" >Continue Reading</a>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="news-card card h-100">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://news.un.org/en/story/2023/06/1137532" className="btn btn-primary" target="_blank">Continue Reading</a>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <div className="news-card card h-100">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://news.un.org/en/story/2023/06/1137777" className="btn btn-primary" target="_blank">Continue Reading</a></div>
                    </div>
                </div>
            </div>
        </div>
