        ...
        <div>
            ...
            <div className='help-content row justify-content-evenly help-container'>
                <div className="col-5 ">
                    ...
                    <div className={`econ ${isDarkMode ? 'text2' : 'text1'}`}>
                    ...
                    <div className={`legal ${isDarkMode ? 'text2' : 'text1'}`}>
                ...
                <div className="col-5">
                    <div className={`chall ${isDarkMode ? 'text2' : 'text1'}`}>
                        <img className="worm-chal" src={chall} />
                    ...
                    <div className={`eng ${isDarkMode ? 'text2' : 'text1'}`}>
                    ...
                    <div className={`inter ${isDarkMode ? 'text2' : 'text1'}`}>
                        <img className="worm-inter" src={inter} />
